...
$server = New-Object Microsoft.SqlServer.Management.Smo.Server  "drmqmc484"
$server.ConnectionContext.Connect()

$smoRestore = New-Object Microsoft.SqlServer.Management.Smo.Restore
$smoRestore.Devices.AddDevice('\\drmqmc484\C$\Octopus\SQL\Core7.bak', "File") 
...
function RestoreDatabase {
    ...
    $smoRestore = New-Object Microsoft.SqlServer.Management.Smo.Restore
    $targetPaths = CreateDevices $smoRestore $devices $BackupDirectory $dbName 
